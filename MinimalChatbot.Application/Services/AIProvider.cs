...
public class AIProvider
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            _logger.LogInformation(
                "Generated content using {Provider}, tokens: {Tokens}",
                providerName,
        ...
        string? modelOverride)
    {
        ...
        {
            messages.Add(ConversationMessage.System(context));
        }
        ...
        {
            Messages = messages,
            SystemPrompt = context ?? _options.DefaultSystemMessage,
            Temperature = _options.Temperature,
            MaxTokens = _options.MaxTokens,
            Metadata = !string.IsNullOrEmpty(model)
                ? new Dictionary<string, object> { ["ModelName"] = model }
