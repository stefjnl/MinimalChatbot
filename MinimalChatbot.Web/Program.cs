...
using MinimalChatbot.Application;
using MinimalChatbot.Application.DI;
...
using MinimalChatbot.Infrastructure.DI;
using MinimalChatbot.Web.Components;
using MinimalChatbot.Web.Endpoints;
using MinimalChatbot.Web.Hubs;
...
builder.Services.AddMinimalChatbotApplication();

// Add Infrastructure layer with LLM
builder.Services.AddMinimalChatbot(builder.Configuration);
...
builder.Services.AddHealthChecks()
    .AddCheck<MinimalChatbot.Infrastructure.HealthChecks.LlmHealthCheck>("llm");
...
builder.Services.AddHttpClient("MinimalChatbot.Api", client =>
{
    client.BaseAddress = new Uri("http://localhost:5244");
});
