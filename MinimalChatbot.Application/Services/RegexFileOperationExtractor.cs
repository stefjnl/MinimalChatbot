namespace MinimalChatbot.Application.Services
{
            ...
            foreach (var pattern in patterns)
            {
                ...
                if (match.Success && match.Groups.Count > 1)
                {
                    ...
                    if (!string.IsNullOrEmpty(filePath))
                    {
                        ...
                        {
                            "Created" => FileOperation.Write(filePath, string.Empty),
                            "Modified" => FileOperation.Write(filePath, string.Empty),
                            "Appended" => FileOperation.Write(filePath, string.Empty),
                            "Deleted" => FileOperation.Delete(filePath),
                            "Moved" => FileOperation.Move(filePath, string.Empty),
                            _ => null
                        };
                    }
                }
