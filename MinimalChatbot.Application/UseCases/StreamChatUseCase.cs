...
public class StreamChatUseCase
{
        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        {
            EventType = ChatStreamEventType.Started,
            Content = initialMetadataPayload
        };
        ...
        {
            if (evt.EventType == ChatStreamEventType.Message && !string.IsNullOrEmpty(evt.Content))
            {
        ...
        yield return new ChatStreamEvent
        {
            EventType = ChatStreamEventType.Completed,
